...
<body>
<div class="container">
	<button class="btn btn-primary"><a href="registrasiUser.php" style="text-decoration:none; color: white; ">register</a></button>
</div>
...
<section>
	<div class="container">
		<div class="row text-center" data-aos="zoom-out" data-aos-duration="1000">
			<div class="col">
		...
		<div class="row justify-content-sm-center">
			<div class="col-sm-6">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<br>
					<div class="sm-3" data-aos="zoom-out" data-aos-duration="1000" data-aos-delay="150">
