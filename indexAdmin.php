	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				<li class="nav-item">
				<a class="nav-link active" href="tambah.php">Tambah Berita</a>
				</li>
				<li class="nav-item">
...
<div class="nav-scroller py-1 mb-2">
	<div class="container">
		...
		<a class="p-2 link-secondary" href="CategoryEntertainmentAdminUser.php">Entertainment</a>
		<a class="p-2 link-secondary" href="CategoryOlahragaAdminUser.php">Olahraga</a>
		<a class="p-2 link-secondary" href="CategoryNasionalAdminUser.php">Nasional</a>
		<a class="p-2 link-secondary" href="CategoryTerpopulerAdminUser.php">Terpopuler</a>
		</nav>
	</div>
</div>
			...
			<div class="card" style="height: auto; " data-aos="flip-left" data-aos-duration="1000">
				...
				<h5 class="card-title"><a href="detail.php?id=<?= $row["id"]; ?>" style="color: black; text-decoration:none"><?= $row["Judul"]; ?></a></h5>
					...
					<div class="buttonBerita p-sm-3" >
						...
						<br><br>
						<button type="submit" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" ><a href="hapus.php?id=<?= $row["id"]; ?>" style="color: white;"  onclick="return confirm('yakin?');">Hapus Berita</a></button>
						<br><br>
						<button type="submit" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal" ><a href="ubah.php?id=<?= $row["id"]; ?>" style="color: white;">Ubah Berita</a></button>
					</div>
				</div>
			</div>			
		</div>
