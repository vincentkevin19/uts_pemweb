<?php 
    ...
    //komentar
    $kom = query("SELECT * FROM `Komentar`");
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="index.php">Berita</a>
      </div>
  ...
  <div class="row g-5">
    <div class="col-md-12">
      ...
      <h3 class="text-center">Komentar</h3>
		<div>
			<div class="row">
				<?php foreach($kom as $kmt): ?>
				<div class="col-sm-4">
					<div class="card" style="width: 18rem;">
						<div class="card-body">
							<h5 class="card-title"><?= $kmt['NamaKomentar']; ?></h5>

							<p class="card-text"><?= $kmt['Komentar'];  ?></p>
						</div>
					</div>
				</div>
				<?php endforeach; ?>
	  ...
	  <div class="text-center">
		  <button class="btn btn-primary" type="submit"><a href="komentar.php" style="color: white;">Beri Komentar</a></button>
	  </div>
    </div>
  </div>
